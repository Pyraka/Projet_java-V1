...
public class Joueur {
    ...
    private ArrayList<Carte> cimetiere = new ArrayList<Carte> (37);
    ...
    public Joueur (int coordX, int coordY, Tortue tortue, ArrayList<Carte> deck, ArrayList<Carte> cimetiere, ArrayList<Carte> hand, ArrayList<Carte> currentAlgorithm, ArrayList<Carte> blocsList) {
        this.coordX = coordX;
        this.coordY = coordY;
        this.tortue = tortue;
        this.deck = deck;
    ...
    public ArrayList<Carte> getBlocsList () {
        return blocsList;
    }

    public void setBlocsList (ArrayList<Carte> blocsList) {
        this.blocsList = blocsList;
    }
