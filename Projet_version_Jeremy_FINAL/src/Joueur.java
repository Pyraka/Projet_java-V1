...
public class Joueur {
    ...
    public void initialisationDeck () {
        ...
        for (int i = 0; i < 18; i++) {
            Carte carteBleue = new Carte ("bleue");
            this.deck.add (carteBleue);
        }
        for (int i = 0; i < 8; i++) {
            Carte carteViolette = new Carte ("violette");
            this.deck.add (carteViolette);
        }
        for (int i = 0; i < 8; i++) {
            Carte carteJaune = new Carte ("jaune");
            this.deck.add (carteJaune);
        }
        for (int i = 0; i < 3; i++) {
            Carte carteLaser = new Carte ("laser");
