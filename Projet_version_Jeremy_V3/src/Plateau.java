    ...
    public void initPlateau (int nbJoueur) {
        switch (nbJoueur) {
            case 2:
                ...
                Joueur joueur1 = new Joueur (0, 1, new Tortue ("TV", 'N'), null, null, null, null, null);
